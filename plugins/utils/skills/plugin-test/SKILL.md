...
**Examples**:
- `/utils:plugin-test code` - Test code plugin
- `/utils:plugin-test cvi` - Test cvi plugin
- `/utils:plugin-test ypm` - Test ypm plugin

## Instructions for Claude

When user invokes `/utils:plugin-test <plugin-name>`:
...
- Re-run /utils:plugin-test <plugin> after fixes
```
